...
module upstairs(in){
  ...
  width = 231;
  length = 247;
  floor1 = [[-178,-369.5,-12.5],0,[458,464+10+8.5,12.5]];
  floor2 = [[-189,-344.0,-12.5],0,[11,93.5,12.5]];
  translate(position)
    rotate([0,0,angle]){
      bathroom2([[132,-65,0],90,wallH]);
      bathroomMaster([[0,0,0],0,wallH]);
      closetMaster([[112+6,-2,0],0,wallH]);
      bedroomMaster([[5,113,0],180,wallH]);
      bedroom1([[127,-156,0],0,wallH]);
      closet1([[127,-151,0],270,wallH]);
      bedroom2([[127,-369.5,0],0,wallH]);
      closet2([[280,-221.5,0],90,wallH]);
      bedroom3([[-25,-369.5,0],0,wallH]);
      loft([[-25,-369.5,0],0,wallH]);
      #box(floor1);
      #box(floor2);
    }
}
...
module briarmanorBasement(in){
  ...
  translate(position)
   ...
   // shelving([[-180+29,32,0],0,[102,96],[6,12,18,24],[1,2,0,2,2]]);
    ...
    shelving([[-180+29,32,0],0,[102,72],[6,12,18,24],[2,1,1,1,1]]);
...
module briarmanorHall(in){
  ...
  stairs([[146.5,341,8],270,[7.5,10.75,14,39]]);

  //firstStep = [[0,0,-12.5],0,[37.5,40,12.5]];
  firstStep = [[104.5,341,-12.5+8],0,[42,37.5,12.5]];
    box(firstStep);
